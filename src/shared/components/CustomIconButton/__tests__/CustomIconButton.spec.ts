...
describe('CustomIconButton.vue', () => {
    it('renders a button with the given aria-label', async () => {
        const render = customRenderer(CustomIconButton).withProps({
            iconName: 'pencil',
            label: 'Edit item',
        });
    ...
    it('applies icon variant class by default', async () => {
        ...
        expect(button).toHaveClass('custom-icon-button--icon');
    });
    ...
    it('applies button variant class when variant is button', async () => {
        ...
        expect(button).toHaveClass('custom-icon-button--button');
    });
